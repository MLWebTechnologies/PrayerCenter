...
<script type="text/javascript">
  ...
  <form action="<?php echo JRoute::_('index.php?option=com_prayercenter&task=manage_dev'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
	   ...
	   <thead>
        ...
        <td class="small hidden-phone"><?php echo JText::_($item->feed); ?></td>
