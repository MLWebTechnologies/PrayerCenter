  ...
  global $prayercenter;
    ...
    if ($this->total>0 ){
      ...
      foreach($showresults as $showrequest){
        ...
        if($this->config_show_viewed || $this->config_show_commentlink) echo '<div class="viewedcommentrounded" style="float:left;padding-left:4px;">';
        ...
        if($this->config_show_requester || $this->config_show_date) echo '<div class="daterounded" style="text-align:right;font-size:x-small;padding-right:4px;">';
